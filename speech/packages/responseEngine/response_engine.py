...
data = pickle.load( open( "F:/Projects II/speech/responseEngine/training_data.p", "rb" ) )
words = data['words']
...
import json
with open('F:/Projects II/speech/responseEngine/intents.json') as json_data:
...
new_model.load('F:/Projects II/speech/responseEngine/model.tflearn')
